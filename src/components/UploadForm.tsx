...
const UploadForm = () => {
    ...
    return (
        <form className='App-uploadForm'>
          { currentUser && (<>
            ...
            { (file && !error) &&(<>
                                        <label 
                                                ...
                                                title='Image title (less than 65 characters)'
                                        >
                                            Title
                                        </label>
                                        <input 
          ...
          { currentUser === null && (<label className='App-uploadForm__placeholder-noauth'>
                                            Uploading files require sign in
                                    </label>)} 
        </form>
    )
}
