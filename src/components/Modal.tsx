        ...
        >
            ...
            >
                ...
                <figcaption className='App-modal__imgInfo'>
                    <span className='App-modal__imgInfo__row title'>
                        {selectedImg.title}
                        <button 
                                className={ isLiked ? 
                                                    'App-modal__imgInfo__likeBtn active' : 
                                                    'App-modal__imgInfo__likeBtn' } 
                                onClick={onLikeClick} 
                                disabled={isOwner || user === 'Anonimous'}>
                        </button>
                        <span className='App-modal__imgInfo__counter'>
                            {likes}
                        </span>
                    </span>
                    <span className='App-modal__imgInfo__row'>
                        {`Uploaded by : ${selectedImg.author.slice(0, selectedImg.author.search(/\@/g))}`}
                    </span>
                    <span className='App-modal__imgInfo__row'>
                    </span>
                </figcaption>
